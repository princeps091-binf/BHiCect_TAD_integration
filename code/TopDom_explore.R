...
write.table(out_mat,file = paste0("./data/TopDom_data/HMEC/",chromo,"_topdom_data.tsv"),sep = "\t",quote = F,col.names = F,row.names = F)
fit <- TopDom(paste0("./data/TopDom_data/HMEC/",chromo,"_topdom_data.tsv"), window.size = 5L,debug=T)
